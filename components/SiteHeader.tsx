...
export function SiteHeader() {
  return (
    <header className="relative z-10 border-b border-white/10 px-4 py-4 md:px-8 md:py-6">
      <section className="mx-auto grid max-w-7xl grid-cols-[1fr_auto] gap-x-3 [grid-template-areas:'logo_status'] md:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] md:items-center md:gap-x-4 md:[grid-template-areas:'logo_tagline_status']">
        <Link
          href="/"
        ...
        <aside className="hidden justify-self-end text-right font-mono text-[9px] leading-snug text-cv-muted [grid-area:status] md:block md:text-xs">
          <p>
